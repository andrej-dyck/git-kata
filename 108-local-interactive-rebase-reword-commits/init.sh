...
wip-commits-ac-automation() {
  ...
  commit-living-room-ac "ac" || return # from 105
  commit-device-traits-schema "fix ac" || return # from 104
  commit-living-room-sensors-thermometer "thermometer" || return # from 105
  commit-living-room-sensors-balcony-door "balcony door" || return # from 105
  commit-living-room-ac-rules "WIP automation" || return # from 106
}
